...
<div class="container p-12">
    ...
    <p class="py-2">
        ...
        stories. Yet others just came to try to make the company of the future: one built on
        transparency, not secrets; accountability, not waivers; and trust, not animosity.
    </p>
    <p class="py-2">
        Our ultimate goal is to build a society where critical thinking, creativity, and
        friendliness thrive, promoting STEAM education, collaboration, and grand ambition. The most
        grand ideas are where the most creativity thrives.
    </p>
    <p class="py-2">
